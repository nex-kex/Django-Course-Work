...
urlpatterns = [
    ...
    path(
        "mailing/<int:pk>/start/confirm/",
        views.MailingStartTemplateView.as_view(),
        name="mailing_start_confirm",
    ),
    path(
        "mailing/<int:pk>/end/confirm/",
        views.MailingEndTemplateView.as_view(),
        name="mailing_end_confirm",
    ),
